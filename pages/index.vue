...
<script>
  ...
  export default {
    ...
    async asyncData ({store}) {
      ...
      let featured = await asyncImport(blogs[0])
      return { featured }
    },
    ...
    head () {
      return {
        ...
        meta: [
          ...
          { name: "description", property: "og:description", content: "Mütevazı bir dille gerçeklerin konuşulduğu, kâr amacı gütmeyen, reklamsız ve emojisiz bir bloğa rastladınız. Konusu olmayan bu blogda her telden yazılar yazılır, resimler çizilir.", hid: "description" },
          { property: "og:title", content: "XNB" },
          { property: "og:image", content: this.ogImage },
          { name: "twitter:description", content: "Mütevazı bir dille gerçeklerin konuşulduğu, kâr amacı gütmeyen, reklamsız ve emojisiz bir bloğa rastladınız. Konusu olmayan bu blogda her telden yazılar yazılır, resimler çizilir." },
